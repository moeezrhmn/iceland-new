                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-4 col-xs-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".5s">
                                        <a href="https://www.guide.is/search?plc=places-to-visit" class="hvr-float">
                                            <i class="fas fa-map-marker-alt"></i>
                                            <span>Search Places of interests</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-xs-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".5s">
                                        <a href="https://www.guide.is/search?rst=restaurant" class="hvr-float">
                                            <i class="fa fa-cutlery"></i>
                                            <span>Restaurants in Iceland</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-xs-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".5s">
                                        <a href="#" class="hvr-float">
                                            <i class="fas fa-envelope"></i>
                                            <span>Vacation Packages Contact Customer Service</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
