...
@section('title', $isNew ? 'Create Administrator' : 'Edit Administrator')
...
@section('content')
                ...
                <div class="mr-auto">
                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="{{route('administrator.index')}}" class="m-nav__link">
 ...
 <button type="submit" class="btn btn-accent">
                                ...
                                @endif
                                <a href="{{route('administrator.index')}}" class="btn btn-secondary">
                                    Cancel
                                </a>
                            </div>
                        </div>
