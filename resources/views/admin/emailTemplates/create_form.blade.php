                            ...
                            <div class="col-md-4 ">
                                <div class="form-group">
                                    ...
                                    <select class="form-control required" name="template_type" aria-required="true">
                                        ...
                                        <option value="reservation-confirm">Reservation confirmed</option>
                                        <option value="trip-planner">Trip planner</option>
                                        <option value="email_confirmation">Confirmation Email Template</option>
                                        <option value="sign_up_welcome">Sign Up Welcome Email Template</option>
                                     <span>*</span></select>
                                </div>
                            </div>
                            <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input value="" name="template_name" type="text" id="place_name" class="form-control required" placeholder="Template  Name" aria-required="true">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input value="" name="template_subject" type="text" class="form-control required" placeholder="Template Subject" aria-required="true">
                                <p class="text-danger"></p>
                            </div>
                        </div>
