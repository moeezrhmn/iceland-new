        ...
        <div class="m-content">
            ...
            <div class="m-portlet">
                ...
                @if(isset($item->id) && !empty($item->id))
                    <form action="{{ route('users.update', $item->id) }}" method="POST" class="m-form m-form--state m-form--fit m-form--label-align-right" id="user-form" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                @else
                    <form action="{{ route('users.store') }}" method="POST" class="m-form m-form--state m-form--fit m-form--label-align-right" id="user-form" enctype="multipart/form-data">
                    @csrf
                @endif
              ...
              <div class="main-img-preview"  style="">
                @if(isset($item->user_photo) && !empty($item->user_photo))
                 <img class="thumbnail img-preview" src="{{url('uploads/'.$item->user_photo)}}" title="Preview Logo" style="width: 100%">
                @else
