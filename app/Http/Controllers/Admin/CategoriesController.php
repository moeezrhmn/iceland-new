...
public function __construct()
   ...
   public function arguments()
    ...
    public function index()
    {
        ...
        return view("admin.categories.datatables", $viewData);
    }
    ...
    public function edit($id)
    {
        ...
        if ($user || $args['isNew']) {
            ...
            return view("admin.categories._form", $args);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->file)
        {
            $image  = $request->file;
             ...
             request()->file->move('uploads/category', $filename);
             $object->cat_image='category/'.$filename;   
        }
       /* if($request->file)
        {
            $filename = $request->file->getClientOriginalName();
            $object->cat_image = $request->file->storeAs(
                'category',rand().'_'.$filename
            );
    ...
    public function categoryListing()
    {
        ...
        return DataTables::of($items)->addColumn('actions', function ($items) use ($currentRoute) {
                ...
                $edit='<a href="' . url("admin/categories/".$items->id.'/edit').'" class="m-portlet__nav-link btn m-btn btn-metal m-btn--icon m-btn--icon-only m-btn--pill" title="Edit">
